...
* Screenshot
#+HTML: <img src="./screenshots/screenshot1.png" alt="" title="screenshot" width="100%" </img>
...
ln -Fs `sudo find /usr/local/Cellar/emacs-mac -name "Emacs.app"` /Applications/Emacs.app
  ...
  2. Solution to incoming network connection:
     ...
     ~codesign --deep --force --verbose --sign frtmelody /usr/local/opt/emacs-mac/Emacs.app~
  #+END_QUOTE
*** Linux
#+BEGIN_SRC shell
# Ubuntu
...
# Clone my config
git clone https://github.com/frtmelody/doom-config ~/.doom.d
